...
> **Personal note:** I got burned by the `adj_close_q` mistake on my first run — the model looked great in backtesting but was using future-leaked prices. The tradedate offset is non-negotiable. Double-check this any time you add new tickers or refresh the price data.
